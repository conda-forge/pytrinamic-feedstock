...
Summary: TRINAMICs Python Technology Access Package.
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytrinamic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytrinamic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install pytrinamic
```
...
It is possible to list all of the versions of `pytrinamic` available on your platform:
...
```
pixi search pytrinamic --channel conda-forge
```
